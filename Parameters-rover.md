...
## CRUISE_P_GAIN: Cruise mode P gain

Set acceleration P gain for Cruise Control mode
...
## AL_BUCK_DEL: BucketDelay

The delay in milliseconds to avoid bucket relay burn
...
## RPM1_PULL: Set pullup or pulldown

*Note: This parameter is for advanced users*

Turn ON MCU internal pullup or pulldown resistor
...
## RPM2_PULL: Set pullup or pulldown
...
## SPRAY_SPIN_DEL: Spinner delay

Spinner's delay in PWM (a higher rate will disperse the spray over a wider area horizontally)
...
## WP_PIVOT_ACCURACY: Accuracy of pivot turn

Angle error to declare pivot turn complete 
...
## WP_PIVOT_DEL_IN: Delay after pivot turn
