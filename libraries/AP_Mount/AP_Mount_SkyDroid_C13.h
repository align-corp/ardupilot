...
#define AP_MOUNT_SKYDROID_PACKETLEN_MAX 1420  // max packet size (1400 data + 20 header/footer)
#define AP_MOUNT_SKYDROID_PACKETLEN_MIN 10    // minimum packet size
#define AP_MOUNT_SKYDROID_DATALEN_MAX 1400    // max data payload
