...
local VOLTAGE_TO_PERCENT_TABLE = {
    ...
    {  0,  0.1,0.025,0.020,0.019,0.018,0.020,0.015,0.030,0.026,0.030}, -- percent per meter                   
    {  0,  0.2,0.075,0.060,0.057,0.055,0.060,0.045,0.090,0.080,0.090}, -- percent per meter down
    {  0, 0.10, 0.10, 0.07, 0.06, 0.20, 0.07, 0.07, 0.07, 0.07, 0.05}, -- voltage drop when flying (per cell)
    ...
    {4.2,  100,  100,  100,   98,  100,  100,  100,  100,  100,   98},
