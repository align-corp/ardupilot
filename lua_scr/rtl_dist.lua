...
local VOLTAGE_TO_PERCENT_TABLE = {
    {  0, 1300, 3500, 4200, 4800, 6000,10000,16000,22000}, -- capacity (mAh)
    {  0,    3,    6,    6,    6,    6,    6,   12,   12}, -- Num cells
    {  0,  0.1,0.025,0.020,0.019,0.020,0.015,0.030,0.026}, -- percent per meter                   
    {  0,  0.2,0.075,0.060,0.057,0.060,0.045,0.090,0.080}, -- percent per meter down
    {3.3,    0,    0,    0,    0,    0,    0,    0,    0},
    {3.4,    0,    2,    0,    0,    1,    9,    4,    2},
    {3.5,   10,    4,    4,    4,    2,   26,    6,    4},
    {3.6,   46,    9,   11,   12,    6,   44,   11,   12},
    {3.7,   72,   39,   42,   38,   28,   59,   38,   46},
    {3.8,   85,   62,   65,   56,   58,   70,   62,   66},
    {3.9,   97,   77,   79,   69,   75,   79,   77,   79},
    {4.0,   99,   88,   90,   79,   86,   90,   88,   90},
    {4.1,  100,  100,  100,   89,  100,  100,  100,  100},
    {4.2,  100,  100,  100,   98,  100,  100,  100,  100},
